...
func (ulq *UserLogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (ulq *UserLogQuery) FirstIDX(ctx context.Context) int64 {
...
func (ulq *UserLogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (ulq *UserLogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (ulq *UserLogQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (ulq *UserLogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := ulq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (ulq *UserLogQuery) GroupBy(field string, fields ...string) *UserLogGroupBy {
	group := &UserLogGroupBy{config: ulq.config}
...
func (ulq *UserLogQuery) Select(fields ...string) *UserLogSelect {
	...
	return &UserLogSelect{UserLogQuery: ulq}
}
...
func (ulq *UserLogQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (ulgb *UserLogGroupBy) StringsX(ctx context.Context) []string {
...
func (ulgb *UserLogGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (ulgb *UserLogGroupBy) sqlQuery() *sql.Selector {
...
func (uls *UserLogSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{userlog.Label}
	default:
		err = fmt.Errorf("ent: UserLogSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (uls *UserLogSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(uls.fields) > 1 {
		return nil, errors.New("ent: UserLogSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := uls.Scan(ctx, &v); err != nil {
		return nil, err
...
func (uls *UserLogSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}

...
func (ugq *UserGroupQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (ugq *UserGroupQuery) FirstIDX(ctx context.Context) int32 {
...
func (ugq *UserGroupQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (ugq *UserGroupQuery) OnlyIDX(ctx context.Context) int32 {
...
func (ugq *UserGroupQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (ugq *UserGroupQuery) IDsX(ctx context.Context) []int32 {
	ids, err := ugq.IDs(ctx)
	if err != nil {
		panic(err)
	}

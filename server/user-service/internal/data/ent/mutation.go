...
func (m *UserLogMutation) SetExtra(s string) {
	m.extra = &s
}

// Extra returns the value of the "extra" field in the mutation.
func (m *UserLogMutation) Extra() (r string, exists bool) {
	v := m.extra
	if v == nil {
		return
	}
...
// OldExtra returns the old "extra" field's value of the UserLog entity.
// If the UserLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserLogMutation) OldExtra(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserLogMutation) ResetExtra() {
	m.extra = nil
}
...
func (m *UserLogMutation) Fields() []string {
	...
	if m.extra != nil {
		fields = append(fields, userlog.FieldExtra)
	}
	if m.create_time != nil {
